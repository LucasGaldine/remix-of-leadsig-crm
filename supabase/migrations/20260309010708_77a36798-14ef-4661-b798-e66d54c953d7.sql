...
-- Create customers table if it does not already exist in the base schema
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Users can view customers in their account'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'customers'
      AND policyname = 'Users can insert customers'
  ) THEN
