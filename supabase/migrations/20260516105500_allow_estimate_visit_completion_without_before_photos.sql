/*
  # Allow estimate-visit completion without before photos

  ## Changes
  - Updates `try_convert_lead_to_job` so estimate-visit jobs no longer require
    before photos to convert into regular jobs.
  - Estimate-visit completion now requires only:
    - All checklist items completed
  - Regular (non-estimate-visit) lead conversion behavior is unchanged:
    - Requires accepted estimate
    - Requires before photo
*/
