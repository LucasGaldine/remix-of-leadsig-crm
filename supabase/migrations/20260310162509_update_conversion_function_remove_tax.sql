/*
  # Update conversion function to remove tax tracking

  1. Changes
    - Remove tax_rate, tax, subtotal, total_with_tax from job creation
    - Job line items contain the actual costs
    - Tax is handled at the estimate/invoice level for customer pricing
*/
