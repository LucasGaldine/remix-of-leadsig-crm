/*
  # Add structured metadata support for job checklist items

  This enables checklist items to carry optional metadata such as category
  while keeping legacy plain-label checklist rows fully compatible.
*/
