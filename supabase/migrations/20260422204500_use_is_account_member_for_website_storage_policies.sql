/*
  # Use security-definer account membership check for website storage policies

  This avoids relying on direct reads from public.account_members in storage
  RLS evaluation and aligns with the app's standard membership helper.
*/
